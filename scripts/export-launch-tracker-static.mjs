...
import { readEarthLaunchTrackerConfig } from "../src/earth-launch-tracker/config.mjs";
import { mapLaunchRecord } from "../src/earth-launch-tracker/normalize.mjs";

const config = readEarthLaunchTrackerConfig();
const rootDir = process.cwd();
const publicDir = path.join(rootDir, "src/earth-launch-tracker/public");
